...
<head>
    ...
    <title>ፍለጋ Admin: Dashboard</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="zergaw.php"><i class="ti-user"></i> Profile</a></li>
                    ...
                    <li><a href="index.php"><i class="ti-file"></i> Documentation</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="float-right">
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <div class="notification-content">
                                                        ...
                                                        <div class="notification-text">Hi zergaw, Just wanted to let you
                                                            ...</div>
                                                    </div>
                                                </a>
                                            </li>
                        ...
                        <div class="dropdown dib">
                            <div class="header-icon" data-toggle="dropdown">
                                <span class="user-avatar">Zergaw
                                    <i class="ti-angle-down f-s-10"></i>
                                </span>
                                <div class="drop-down dropdown-profile dropdown-menu dropdown-menu-right">
                                    <div class="dropdown-content-heading">
                                        <span class="text-left">LifeTime access</span>
                                        <p class="trial-day">Administrator</p>
                                    </div>
                                    <div class="dropdown-content-body">
                                        <ul>
                                            <li>
                                                <a target="_blank" href="zergaw.php">
                                            ...
                                            <li>
                                                <a  class="btn btn-info btn-lg" onclick="logout()"> Log out
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
    ...
    <div class="content-wrap">
        <div class="main">
            <div class="container-fluid">
				...
				<h1>Hello, Zergaw <span> Welcome Here</span></h1>
				<div class="w3-panel w3-round-large w3-animate-fading ">
					<h2> HERE YOU GO: <code> <?php echo Flag ?> </code></h2>
				</div>
